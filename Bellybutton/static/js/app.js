...
console.log( sample_data);
    ...
    let bubbleLayout = {
      title: {
        ...
        font:{
          family: 'Verdana, sans-serif', // Set the font family
          size: 20, // Set the font size in pixels
          color: '#505050',// Set the font color (e.g., black)
    ...
    let bubble_sample = [{
      ...
      marker: {
        size : sample_values,
        color: otu_ids,
        colorscale:  [[0, 'rgb(166,206,227)'], [0.25, 'rgb(31,120,180)'], [0.45, 'rgb(178,223,138)'], [0.65, 'rgb(51,160,44)'], [0.85, 'rgb(251,154,153)'], [1, 'rgb(227,53,53)']]},
      text: otu_labels
      }];
